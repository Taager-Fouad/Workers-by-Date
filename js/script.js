...
function renderTable(){
  ...
  const exclude = ["resigned","dismissed","upl","ksa","gcc","whatsapp","tele ksa","tele-sales iraq","tele-sales","tele egy","iraq cr","iraq","eg ts","validation team","#n/a","tele iraq","egy","tele","sus","termination","support","egy cr","irq cr","egy ts","ksa cr","gcc cr","transferred"];
